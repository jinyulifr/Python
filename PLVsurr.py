...
#%%
for level in [0,1]:
    for wav_file in glob.glob(path+"recordings/part"+str(part)+"/"+"*.wav"):
    # for wav_file in glob.glob("/Users/jinyuli/Downloads/test/"+"*.wav"):
        ...
        # wav_file = "/Users/jinyuli/Downloads/test/F_13_12_moma_LH.wav"    
        # wav_file = "/Users/jinyuli/Downloads/test/F_14_8_moma_HL.wav"    
        # wav_file = "/Volumes/Jinyu LI/PASDCODE/Experiments/exp_SynchroSpeech/recordings/part2/F_14_6_moma_LH.wav"
        # filename = "F_01_17_mama_LH.wav"
        ...
        # #### GET surrogate PLV (my version)
        # ramdomArray=np.random.randint(1,len(AMs), size=100)
        # surrPLVlst=[]
        # for r in range(len(ramdomArray)):
        #     thisSyllSurrSigs=np.concatenate((AMs[:,1][ramdomArray[r]:],AMs[:,1][0:ramdomArray[r]]))
        ...
        #### GET surrogate PLV (Leo's version)
        surrPLVlst=[]
